...
<v-img
  ...
  src="https://logodownload.org/wp-content/uploads/2016/11/formula-1-logo-0.png">
    ...
    <v-toolbar-title v-if="this.$store.state.logged == true"><router-link class="link" to="/"><v-btn class="close" @click="closeSession"><v-list-item prepend-icon="mdi mdi-close-circle-outline">Close Session</v-list-item></v-btn></router-link></v-toolbar-title>
